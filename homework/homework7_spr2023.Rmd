...
3. (False Discovery) Are many medical discoveries actually Type 1 errors? In medical research, suppose that 10% of null hypotheses are actually false, and that when a null hypothesis is false, the chance of making a Type II error and failing to reject it (for example, due to insufficient sample size) is 0.55.
  ...
  Write a function in R (show your code) to perform the FDR computation in part a. which takes as input: the probability of $H$, the Type 1 and Type 2 error rates, and calculates the FDR. Then run it for all combinations of the following inputs:
...
& \multicolumn{4}{c|}{0.0001} & \multicolumn{4}{c|}{0.005}\\ \hline
 & \multicolumn{4}{c|}{Type II error} & \multicolumn{4}{c|}{Type II error}  \\ \hline
$P(H)$ & 0.05 & 0.2 & 0.3 & 0.5 & 0.05 & 0.2 & 0.3 & 0.5  \\ \hline
0.05 & & & & & & & &   \\ \hline
0.10 & & & & & & & &   \\ \hline
0.20 & & & & & & & &   \\ \hline
0.50 & & & & & & & &   \\ \hline \hline
...
& \multicolumn{4}{c|}{Type II error} & 
\multicolumn{4}{c|}{Type II error}  \\ \hline
$P(H)$ & 0.05 & 0.2 & 0.3 & 0.5 & 0.05 & 0.2 & 0.3 & 0.5 \\ \hline
0.05 & & & & & & & &   \\ \hline
0.10 & & & & & & & &   \\ \hline
0.20 & & & & & & & &   \\ \hline
